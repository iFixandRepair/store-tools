    ...
    <body>
        ...
        <div class="container" id="mainContainer" style="display:none;">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" id="TabVR" class="active">				<a href="#ViewReport" 	aria-controls="home" role="tab" data-toggle="tab">View Report</a></li>
				<li role="presentation" id="TabUS" style=" display:none;">		<a href="#uploadSales" 	aria-controls="home" role="tab" data-toggle="tab">Upload Sales</a></li>
				<li role="presentation" id="TabSG" style=" display:none;">		<a href="#storeGoals" 	aria-controls="home" role="tab" data-toggle="tab">Store Goals</a></li>
			</ul>
			<div class="tab-content">				
				<!-- View Report Tab -->
				<div role="tabpanel" class="tab-pane fade in active" id="ViewReport">
				...
				<!-- Upload Sales Tab -->	
				<div role="tabpanel" class="tab-pane fade" id="uploadSales">	
				...
				<!-- Store Goals Tab -->
				<div role="tabpanel" class="tab-pane fade" id="storeGoals">	
					<div id="messages-sg" name="messages-sg" class="messages-sg"></div>		
					<form  method="post" enctype="multipart/form-data" class="form-inline  navbar navbar-default formulario-sg" id="FormUploadStoreGoals" style="display: none;">
						<div class="form-group" >
							<div class="row">
								<div class="col-md-4">
									<label for="salesReport">Month</label>
								</div>
								<div class="col-md-8">
									<select id='cmdMonth' name='cmdMonth' class="combobox">
		  								<option></option>
							...
							<div class="row">
								<div class="col-md-4">
									<label for="storeGoals">Store Goals</label>
								</div>
								<div class="col-md-8">
									<input type="file" class="form-control" name="storeGoals" id="storeGoals">
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<input type="button" id="btn-upload-SG" value="Upload" name="btn-upload-SG" class="btn btn-primary">
								</div>
							</div>
						</div>
					</form>
